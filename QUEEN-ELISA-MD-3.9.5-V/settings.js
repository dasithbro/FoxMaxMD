...
SUPPORT GROUP - https://t.me/foxmaxdigital



ℹ️ SPECIAL INFORMATION ℹ️

Welcome to FoxMax Whatsapp Bot settings.js.
...
global.cap = "© FoxMax Digital";
//👇 Your Bot Name
global.botnma = "FoxMax 1.0";
//👇 Your name
global.ownernma = "FoxMax Digital";
//👇 Sticker Author Name
global.packname = "FoxMax";
//👇 Inbox Block Massage
global.INBOX_BLOCK_MSG = "BLOCK !!!";
//👇 Owner React Imoji
global.OWNER_REACT = "🧑‍💻";
//👇 Song Download Massage
global.SONG_DOWN = "```⬇️ Downloading Content...```";
//👇 Song Uplode massage
global.SONG_UP = "```⬆️ Uploding Content...```";
//👇 Menu imoji
...
global.LANG = "EN";
//Alive logo
global.alivelogo = process.env.ALIVE_IMAGE || `https://ibb.co/YdP9mKG`;
//👇 Alive message
...
global.mess = {
  ...
  ONLY_SEX_GROUP:
    "Adult Video Download Only Allowed On This Group \n\n https://chat.whatsapp.com/JYAg2lMpRTF2bgkeFCxsvf",
...
global.imgalive = fs.readFileSync("./Media/image/logo.jpg");
